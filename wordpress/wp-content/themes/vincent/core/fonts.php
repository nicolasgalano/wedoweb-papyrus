...
$vincent_fonts_array = json_decode('
    {
...
function vincent_get_all_fonts_name()
{
    global $vincent_fonts_array;

    if (is_array($vincent_fonts_array['items'])) {
        foreach ($vincent_fonts_array['items'] as $key => $font) {
...
# Register Fonts
add_action('wp_enqueue_scripts', 'vincent_register_theme_fonts');
function vincent_register_theme_fonts()
{
    $fonts_array = array();

    # Menu Font
    $fonts_array[vincent_get_theme_mod('header_menu_font_family')] = ':400,' . vincent_get_theme_mod('header_menu_font_weight');

    # Sub Menu Font
    $fonts_array[vincent_get_theme_mod('header_sub_menu_font_family')] = ':300';

    # Main Font
    $fonts_array[vincent_get_theme_mod('main_font_family')] = ':300,400,700,' . vincent_get_theme_mod('main_font_weight');

    # Headings Font
    $fonts_array[vincent_get_theme_mod('alternate_font_family')] = ':400,700';

    # Font For Text Logo
    if (vincent_get_theme_mod('logo_type') == 'text_logo') {
        $fonts_array[vincent_get_theme_mod('logo_text_font')] = ':400,700,' . vincent_get_theme_mod('logo_text_weight');
    }

    # Font For Footer Text Logo
    if (vincent_get_theme_mod('footer_logo_type') == 'text_logo') {
        $fonts_array[vincent_get_theme_mod('footer_logo_text_font')] = ':400,700,' . vincent_get_theme_mod('footer_logo_text_weight');
    }
    ...
    wp_enqueue_style('vincent-fonts', $font_url, array());
}